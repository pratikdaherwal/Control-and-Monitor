...
//Maintainance
//Temprature
$sqltmp = "SELECT `c2units` FROM `readings` WHERE `parameters` = 'temperature'";
...
// Humidity
$sqlhum = "SELECT `c2units` FROM `readings` WHERE `parameters` = 'humidity'";
...
// Gas
$sqlgas = "SELECT `c2units` FROM `readings` WHERE `parameters` = 'gas'";

...
//Maintainance
//Temprature
$sqltmp = "SELECT `c4units` FROM `readings` WHERE `parameters` = 'temperature'";
...
// Humidity
$sqlhum = "SELECT `c4units` FROM `readings` WHERE `parameters` = 'humidity'";
...
// Gas
$sqlgas = "SELECT `c4units` FROM `readings` WHERE `parameters` = 'gas'";

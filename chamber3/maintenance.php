...
//Maintainance
//Temprature
$sqltmp = "SELECT `c3units` FROM `readings` WHERE `parameters` = 'temperature'";
...
// Humidity
$sqlhum = "SELECT `c3units` FROM `readings` WHERE `parameters` = 'humidity'";
...
// Gas
$sqlgas = "SELECT `c3units` FROM `readings` WHERE `parameters` = 'gas'";
